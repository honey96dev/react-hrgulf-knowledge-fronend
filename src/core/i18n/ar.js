export default {
  ...
  ABOUT: {
    ...
    VISION_TITLE: "رؤية المجتمع الخليجي لرأس المال البشري",
    VISION_DESCRIPTION: "الريادة الخليجية في حلول إدارة رأس المال البشري النظري والتطبيقي.",
    MISSION_TITLE: "رسالة المجتمع الخليجي لرأس المال البشري",
    ...
    GOAL_TITLE: "أهداف المجتمع الخليجي لرأس المال البشري",
    GOAL_DESCRIPTION: "الريادة في تنمية الأفراد ورفع كفاءة المنظمات.\n" +
      "تعزيز التعاون مع شركاء التطوير ورفع الكفاءة.\n" +
      "تمكين الشركاء ورفع مستوى المعرفة.\n" +
      "تحقيق تميز وثقافة المجتمع.\n",
  },
};
