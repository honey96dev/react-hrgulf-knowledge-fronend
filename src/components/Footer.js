...
import {SOCIAL_TWITTER, SOCIAL_YOUTUBE, SOCIAL_LINKEDIN, SOCIAL_SNAPCHAT, SOCIAL_WHATSAPP} from "core/globals";
      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="3" className={`mx-auto mt-3 ${classTextAlignRight}`}>
            ...
            <img src={images.ghcsNoTitle300} className="footer-company-logo"/>
            ...
            <div className="text-center text-md-right">
              <ul className="list-unstyled list-inline">
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href={SOCIAL_TWITTER} target="_blank">
                    <i className="fab fa-twitter" />
                  </a>
                </li>
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href={SOCIAL_YOUTUBE} target="_blank">
                    <i className="fab fa-youtube" />
                  </a>
                </li>
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href={SOCIAL_LINKEDIN} target="_blank">
                    <i className="fab fa-linkedin-in" />
                  </a>
                </li>
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href={SOCIAL_SNAPCHAT} target="_blank">
                    <i className="fab fa-snapchat" />
                  </a>
                </li>
                <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href={SOCIAL_WHATSAPP} target="_blank">
