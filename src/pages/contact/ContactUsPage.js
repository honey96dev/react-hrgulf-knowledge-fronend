...
export default () => {
  ...
  const [name, setName] = useState(isDev ? DEFAULT_USERNAME : "");
        ...
        <MDBRow className="mt-5">
            ...
            <form onSubmit={handleSubmit} className="pr-lg-4">
              <div className="grey-text">
                <MDBRow>
                  ...
                  <MDBCol md={12}>
                    <MDBInput id="message" name="message" type="textarea" rows={TEXTAREA_ROWS1} label={t("CONTACT.US.MESSAGE")} outline value={message}
          ...
          <MDBCol md={5} className="mt-3" dir="ltr">
            <div className="mb-5">
              ...
              <span className="contact-item">{CONTACT_PHONE}</span>
            </div>
            <div className="mb-5">
              <MDBIcon icon="phone" className="contact-icon mr-4-f"/>
              <span className="contact-item">{CONTACT_MOBILE}</span>
            </div>
            <div className="mb-5">
              <MDBIcon icon="envelope" className="contact-icon mr-4-f"/>
              <span className="contact-item">{CONTACT_EMAIL}</span>
            </div>
            <div className="mb-5">
