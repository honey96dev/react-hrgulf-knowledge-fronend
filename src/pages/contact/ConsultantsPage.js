...
import {ALERT_DANGER, SUCCESS, DESCRIPTION_LENGTH_BREAKPOINT} from "core/globals";
...
export default () => {
  ...
  const adjustItems = items => {
    for (let item of items) {
      item["descriptionEn2"] = item["descriptionEn"].length > DESCRIPTION_LENGTH_BREAKPOINT ? item["descriptionEn"].substr(0, DESCRIPTION_LENGTH_BREAKPOINT) + "..." : item["descriptionEn"];
      item["descriptionAr2"] = item["descriptionAr"].length > DESCRIPTION_LENGTH_BREAKPOINT ? item["descriptionAr"].substr(0, DESCRIPTION_LENGTH_BREAKPOINT) + "..." : item["descriptionAr"];
    }
    return items;
  };
