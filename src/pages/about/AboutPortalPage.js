...
export default () => {
  ...
  return (
    <Fragment>
      ...
      <MDBRow className="front-section">
        <MDBCol className="mb-5" md={4}>
          <MDBCard className="section-card">
            ...
            <MDBCardBody>
              ...
              <MDBCardText className="text-left mt-4">{t("ABOUT.VISION_DESCRIPTION")}</MDBCardText>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
        <MDBCol className="mb-5" md={4}>
          <MDBCard className="section-card">
            ...
            <MDBCardBody>
              ...
              <MDBCardText className="text-left mt-4">{t("ABOUT.MISSION_DESCRIPTION")}</MDBCardText>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
        <MDBCol className="mb-5" md={4}>
          <MDBCard className="section-card">
            ...
            <MDBCardBody>
              ...
              <MDBCardText className="text-left mt-4">{t("ABOUT.GOAL_DESCRIPTION")}</MDBCardText>
            </MDBCardBody>
          </MDBCard>
        </MDBCol>
      </MDBRow>
