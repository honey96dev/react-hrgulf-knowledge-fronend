          ...
          <MDBRow>
            <MDBCol md={6}>
              ...
              {!editing && <MDBInput label={t("AUTH.GENDER")} disabled background
                                     value={!!gender ? gender === GENDER_MALE ? t("COMMON.GENDER.MALE") : t("COMMON.GENDER.FEMALE") : ""}/>}
            ...
            <MDBCol md={6}>
              {!!editing && <Fragment>
                <MDBDatePicker format={DATE_FORMAT_ISO} autoOk keyboard disabled={!editing} className="date-picker"
