...
export default () => {
  ...
  return (
    <Fragment>
      ...
      <MDBBreadcrumb>
        <MDBBreadcrumbItem active>{t('NAVBAR.POSTS.POSTS')}</MDBBreadcrumbItem>
      ...
      {!loading && !!items.length && <MDBRow>
        ...
        <MDBCol md={12}>
          <Magazines items={items} detailLabel={t("COMMON.BUTTON.READ_MORE")} detailLink={routes.posts.magazineDetail} />
        </MDBCol>
        <MDBCol md={12} className="text-center">
          <div className="mt-5">
            <Pagination circle current={currentPage} pageCount={pageCount} width={10} onChange={handlePageChange}/>
